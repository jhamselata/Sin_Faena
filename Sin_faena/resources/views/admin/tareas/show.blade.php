                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="form-horizontal" method="post" action="{{ route('admin.tareas.edit', $tarea->id) }}">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-sm">
                                        <div class="mb-3 text-dark">
                                            ...
                                            <input type="text" class="form-control {{$errors->has('titulo_tarea') ? 'is-invalid' : ''}}" id="titulo_tarea" placeholder="titulo de la tarea" name="titulo_tarea" autofocus value="{{old('titulo_tarea', $tarea->titulo_tarea)}}" disabled />
                                    ...
                                    <div class="col-sm">
                                        <div class="mb-3 text-dark">
                                            ...
                                            <textarea name="descripcion_tarea" class="form-control" autofocus disabled>{{old('descripcion_tarea', $tarea->descripcion_tarea)}}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-sm">
                                        <div class="mb-3 text-dark">
                                            ...
                                            <input type="date" class="form-control date" name="comenzar_tarea" id="comenzar_tarea" disabled value="{{ old('comenzar_tarea', $tarea->comenzar_tarea)}}" required autofocus />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm">
                                        <div class="mb-3 text-dark">
                                            ...
                                            <input type="date" class="form-control date" name="terminar_tarea" disabled value="{{ old('terminar_tarea', $tarea->terminar_tarea) }}" required autofocus />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm">
                                        <div class="mb-3 text-dark">
                                            ...
                                            <select class="form-control {{ $errors->has('prioridad_tarea') ? 'is-invalid' : '' }}" disabled name="prioridad_tarea" id="prioridad_tarea" required autofocus>
                                    ...
                                    <div class="col-sm">
                                        <div class="mb-3 text-dark">
                                            ...
                                            <select class="form-control {{ $errors->has('estado_tarea') ? 'is-invalid' : '' }}" disabled name="estado_tarea" id="estado_tarea" required autofocus>
