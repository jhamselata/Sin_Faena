                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="form-horizontal" method="post">
                                ...
                                <div class="row">
                                    <div class="col-sm">
                                        <div class="mb-3 text-dark">
                                            ...
                                            <input type="text" class="form-control {{$errors->has('nombre_tipoCli') ? 'is-invalid' : ''}}" id="nombre_tipoCli" placeholder="Nombre del tipo de cliente" name="nombre_tipoCli" autofocus value="{{old('nombre_tipoCli', $tipocliente->nombre_tipoCli)}}" readonly />
                                ...
                                <div class="row">
                                    <div class="col-sm">
                                        <div class="mb-3 text-dark">
                                            ...
                                            <textarea type="text" class="form-control {{$errors->has('descripcion_tipoCli') ? 'is-invalid' : ''}}" id="descripcion_tipoCli" placeholder="Descripción de las funciones y características del tipo de cliente" name="descripcion_tipoCli" autofocus readonly>{{old('descripcion_tipoCli', $tipocliente->descripcion_tipoCli)}}</textarea>
                                ...
                                <a href="{{ route('admin.tipoclientes.edit', $tipocliente->id) }}" class="btn btn-primary">
                                    <i>Editar</i>
                                </a>
