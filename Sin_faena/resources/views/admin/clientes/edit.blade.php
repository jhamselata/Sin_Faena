                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="form-horizontal" method="post" action="{{ route('admin.clientes.update', $clientes->id) }}">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="col-sm">
                                        ...
                                        <label for="id_usuario" class="form-label">Usuario</label>
                                            <select class="form-control select2" name="id_usuario" style="width: 100%;" autofocus>
                                                ...
                                                <option value="{{ $user->id }}" {{ (old('id_usuario') ? old('id_usuario') : ($clientes->id_usuario ?? '')) == $user->id ? 'selected' : '' }}>
                                                    {{ $user->name }}
                                                </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-sm">
                                        <div class="mb-3 text-dark">
                                            ...
                                            <select class="form-control select2" name="id_tipoCliente" style="width: 100%;" autofocus>
                                                ...
                                                <option value="{{ $tipo_cliente->id }}" {{ (old('id_tipoCliente') ? old('id_tipoCliente') : ($clientes->id_tipoCliente ?? '')) == $tipo_cliente->id ? 'selected' : '' }}>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm">
                                            <div class="mb-3 text-dark">
                                                ...
                                                <input type="text" class="form-control {{$errors->has('nombre_cli') ? 'is-invalid' : ''}}" id="nombre_cli" placeholder="Nombre del cliente" name="nombre_cli" autofocus value="{{old('nombre_cli', $clientes->nombre_cli)}}"/>
                                        ...
                                        <div class="col-sm">
                                            <div class="mb-3 text-dark">
                                                ...
                                                <input type="text" class="form-control {{$errors->has('apellido_cli') ? 'is-invalid' : ''}}" id="apellido_cli" placeholder="Apellido del cliente" name="apellido_cli" autofocus value="{{old('apellido_cli', $clientes->apellido_cli)}}" />
                                        ...
                                        <div class="col-sm">
                                            <div class="mb-3 text-dark">
                                                ...
                                                <input type="text" class="form-control {{$errors->has('rnc_cli') ? 'is-invalid' : ''}}" id="rnc_cli" placeholder="RNC del cliente" name="rnc_cli" autofocus value="{{old('rnc_cli', $clientes->rnc_cli)}}" />
                                    ...
                                    <div class="col-sm">
                                        <div class="mb-3 text-dark">
                                            ...
                                            <select class="form-control {{ $errors->has('estado_cli') ? 'is-invalid' : '' }}" name="estado_cli" id="estado_cli" required autofocus>
                                                ...
                                                <option value="{{ $status }}" {{ (old('estado_cli') ? old('estado_cli') : $clientes->estado_cli ?? '') == $status ? 'selected' : '' }}>{{ $status }}</option>
                                                @endforeach
                                            </select>
